...
public class DatePickerPopWin extends PopupWindow implements OnClickListener {
    ...
    public static class Builder {
        ...
        private int maxYear = Calendar.getInstance().get(Calendar.YEAR) + 1 - 18;
...
//        dayLoopView.setTextSize(25);
    ...
    private void initDaysPickView() {
        ...
        if ((minYear + yearPos + 1) == maxYear && (monthPos == month)) {
            dayMaxInMonth = calendar.get(Calendar.DAY_OF_MONTH);
        } else {
    ...
    private void initMonthPickView() {
        Calendar calendar = Calendar.getInstance();
        monthList.clear();
        int i = -1;
        if ((minYear + yearPos + 1) == maxYear) {
    ...
    public void setSelectedDate(String dateStr) {
        ...
        if (!TextUtils.isEmpty(dateStr)) {
            ...
            if (milliseconds != -1) {
                ...
                yearPos = calendar.get(Calendar.YEAR) - minYear - 18;
                monthPos = calendar.get(Calendar.MONTH);
